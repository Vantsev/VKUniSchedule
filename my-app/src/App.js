        ...
        <div>
          {schedule.error ? ( //Проверка на наличие ошибки в расписании. Если ошибки нет, отображаем расписание.
            <p>{schedule.error}</p>
              ...
              //Преобразуем объект расписания в массив и перебираем его. Каждый день недели (day) и соответствующие уроки
              // (lessons) отображаются в виде заголовков (<h2>{day}</h2>).
